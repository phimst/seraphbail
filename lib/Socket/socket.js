...
const makeSocket = u => {
    ...
    const p = async a => {
        if (V) {
            ...
            const _sbailCode = a?.output?.statusCode;
            const _sbailDelayMap = { 405: 3000, 408: 2000, 428: 5000, 429: 60000, 500: 5000, 503: 10000 };
            const _sbailReconnectMs = _sbailDelayMap[_sbailCode] ?? 1000;
            l.emit("connection.update", {
                ...
                suggestedReconnectMs: _sbailReconnectMs
            });
