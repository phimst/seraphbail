...
const DEFAULT_CONNECTION_CONFIG = exports.DEFAULT_CONNECTION_CONFIG = {
  ...
  // seraphbail additions
  maxDeviceCacheKeys: 500,
  enableAdaptiveThrottle: true,
  riskScoreOptions: undefined,
  adaptiveThrottleOptions: undefined,
  enableDonateCommand: false,
  donateCommand: '.seraphdonate',
  donateImagePath: undefined,
  donateCaption: undefined
};
